...
export const MODULE_OPTIONS: ModuleOption[] = [
  ...
  },
  {
    module: "debts",
    label: "Debt Ledger",
    description: "Submit, review, and settle daily debt explanations.",
    route: ROUTES.ADMIN_DEBTS,
  },
];
...
export const ACCOUNTING_PERMISSION_PROFILE: Record<
  UserRole,
  AccountingPermissionProfile
> = {
  boss: {
    role: "boss",
    label: "Boss",
    modules: ["vip", "bar", "reception", "inventory", "approval", "debts"],
    readOnlyModules: [],
    editableModules: ["vip", "bar", "reception", "inventory", "debts"],
    actions: [
      "create",
      "edit",
      "submit",
  ...
  admin: {
    role: "admin",
    label: "Admin",
    modules: ["vip", "bar", "reception", "inventory", "debts"],
  ...
  "bar-master": {
    ...
    modules: ["bar", "debts"],
    readOnlyModules: [],
    editableModules: ["bar", "debts"],
    actions: ["create", "edit", "submit"],
  },
  receptionist: {
    role: "receptionist",
    label: "Receptionist",
    modules: ["reception", "debts"],
    readOnlyModules: [],
    editableModules: ["reception", "debts"],
    actions: ["create", "edit", "submit"],
  },
};
